...
const {registerUserController,loginUserController}=require("../controller/user-authentication-controller");
...
router.post('/api/users', handleRoute(async (req, res) => {
...
router.post('/api/users/profile-picture', upload.single('profile_picture'), handleRoute(async (req, res) => {
